# Operator Quickstart — Event Catering

Shortest path from clone to a verified local dry-run for **ISIC 5621** (`cloud-itonami-isic-5621`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5621.git
cd cloud-itonami-isic-5621
```
...
- Blueprint governor key: `catering-governor`
